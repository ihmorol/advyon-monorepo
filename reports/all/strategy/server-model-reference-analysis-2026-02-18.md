...
- Validation evidence
  - `tests/smoke/api.smoke.test.ts` and `reports/all/strategy/api-smoke-matrix-2026-02-18.md` confirm previously failing notification/schedule endpoints now pass.
