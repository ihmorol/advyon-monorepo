...
- Branch: `ihm/feat/public-content-metadata`
- Segment `2.1` Branch: `ihm/feat/2.1/public-static-pages`
- Segment `2.2` Branch: `ihm/feat/2.2/public-remaining-scope`
...
- Start each session with: `git fetch origin --prune`, `git checkout ihm/feat/public-content-metadata`, `git pull --rebase origin ihm/feat/public-content-metadata`.
...
- Push fequently, never exceeds over 3files to be uncommitted. and update SSOT evidence links in the same cycle.
