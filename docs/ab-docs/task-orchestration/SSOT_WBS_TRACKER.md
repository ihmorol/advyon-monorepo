...
| WBS-DEP-SV-01 | Enabler | Team 5 | DN | Pass | Pass | Pass | Commit after >=3 files or logical unit | Installed stripe SDK, created stripe.config.ts, updated config/index.ts |
...
| WBS-SM-MVP-02 | Governance | Teams 1-5 | DN | Pass | Pass | Pass | Zod schemas | All Team 5 endpoints have Zod validation (admin + billing) |
| WBS-SM-MVP-03 | Governance | Team 5 | DN | Pass | Pass | Pass | Stripe integration | Webhook handler, checkout sessions, portal sessions verified |
| WBS-SM-MVP-04 | Governance | Team 5 | DN | Pass | Pass | Pass | Admin endpoints | All admin CRUD + bulk ops + audit logging verified |
| WBS-SM-MVP-05 | Governance | Team 4 | NS | Pending | Pending | N/A | Commit after >=3 files or logical unit | TBD |
| WBS-SM-MVP-06 | Governance | Team 5 | DN | Pass | Pass | N/A | health.route.ts + docs | Health endpoint + uptime-governance.md with SLO targets |
| WBS-SM-MVP-07 | Governance | Team 2 | NS | Pending | Pending | N/A | Commit after >=3 files or logical unit | TBD |
| WBS-SM-KPI-01 | Governance | Team 5 | DN | Pass | Pass | N/A | kpi.service.ts | getRegistrationKPIs with 30d trends, daily breakdown, by-role |
...
| WBS-SM-KPI-06 | Governance | Team 5 | DN | Pass | Pass | N/A | kpi.service.ts | getRevenueKPIs with 30d revenue, daily breakdown, by-plan |
